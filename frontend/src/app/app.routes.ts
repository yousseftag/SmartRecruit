...
export const routes: Routes = [
  ...
  },
  {
    path: 'candidats',
    loadComponent: () =>
      import('./pages/candidates/candidates-list/candidates-list').then((c) => c.CandidatesList),
  },
  {
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/candidates/candidate-import/candidate-import').then((c) => c.CandidateImport),
  },
  {
    path: 'candidats/:id',
    loadComponent: () =>
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/settings/general-settings/general-settings').then((c) => c.GeneralSettings),
  },
  {
