...
<head>
    ...
    <title>Forgot Password - Smart Recruit</title>
...
<div class="login-card">
    ...
    <form action="${url.loginAction}" method="post">
        ...
        <div style="display: flex; gap: 12px; margin-top: 20px;">
            <a href="${url.loginUrl}" class="btn" style="flex: 1; text-align: center; background-color: #f1f5f9; color: #475569; border: 1px solid #cbd5e1; text-decoration: none; display: flex; align-items: center; justify-content: center;">Back to Login</a>
            <button type="submit" class="btn btn-primary" style="flex: 2;">Submit</button>
        </div>
